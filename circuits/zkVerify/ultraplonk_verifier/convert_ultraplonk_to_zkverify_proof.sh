...
noir-cli proof-data -n 12 --input-proof ../../target/health_data_sharing_proof.bin --output-proof ../output_zkverify_version_of_proof_pubs_vk/zkv_health_data_sharing_proof.bin --output-pubs ../output_zkverify_version_of_proof_pubs_vk/zkv_health_data_sharing_pubs.bin
